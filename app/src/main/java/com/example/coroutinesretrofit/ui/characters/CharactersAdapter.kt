...
import com.fclarke.coroutinesretrofit.databinding.ItemCharacterBinding
...
class CharacterViewHolder(
    ...
    fun bind(item: Character) {
        this.character = item
        itemBinding.name.text = item.content
        itemBinding.speciesAndStatus.text = """${item.content} - ${item.content}"""

    }

    override fun onClick(v: View?) {
        listener.onClickedCharacter(character.id.toInt())
    }
}
